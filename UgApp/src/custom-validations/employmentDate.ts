...
export function employmentDateValidator(control: AbstractControl): { [key: string]: boolean } | null {
    const today = currentDate();
    const employmentDate = control.get('fechaIngreso');
    return employmentDate && employmentDate.value > today ? { misMatch: true } : null;
}
